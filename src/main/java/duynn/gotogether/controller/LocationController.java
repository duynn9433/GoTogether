...
//    public ResponseEntity<?> newUpdateDriverLocation(@RequestBody ClientUpdateLocationRequest request) {
//        try{
...
//    @Transactional
//    public ResponseEntity<?> newUpdatePassengerLocation(@RequestBody ClientUpdateLocationRequest request) {
//        try{
