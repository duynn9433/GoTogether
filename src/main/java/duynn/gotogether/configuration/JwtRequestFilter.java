...
import duynn.gotogether.exception.MyAuthenticationException;
...
//                throw new MyAuthenticationException("Unable to get JWT Token");
            } catch (ExpiredJwtException e) {
                System.out.println("JWT Token has expired");
//                throw new MyAuthenticationException("JWT Token has expired");
            } catch (SignatureException e) {
                System.out.println("JWT Token has invalid signature");
//                throw new MyAuthenticationException("JWT Token has invalid signature");
            }
        } else {
            logger.warn("JWT Token does not begin with Bearer String");
//            throw new MyAuthenticationException("JWT Token does not begin with Bearer String");
        }
